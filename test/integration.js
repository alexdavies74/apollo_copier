...
describe("Integration", function() {
    ...
    describe("#_importTasks()", function() {
        ...
        it("should create a task with and without various properties", function() {
            ...
            expect(exp.taskDataSource()(0,50).mapPerform("toJS")).to.deep.equal([
                { sourceId: 100, name: "task1", creator: 1234, notes: "", completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: null, sourceAssigneeId: null, sourceItemIds: [], sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], recurrenceData: null, resourceSubtype: undefined, recurrenceType: null, customFieldValues: [] },
                { sourceId: 101, name: "task2", creator: 1234, notes: "desc", completed: true, startOn: "2023-11-15 00:00:00", dueOn: "2023-11-30 00:00:00", public: false, assigneeStatus: "upcoming", sourceAssigneeId: null, sourceItemIds: [], sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: null, customFieldValues: [] },
                // Milestone
            ...
            expect(client.tasks.create).to.have.been.calledWithExactly({ _sourceId: 100, workspace: orgId, name: "task1", html_notes: "<body></body>", completed: false, start_on: null, due_on: null, force_public: false, hearted: false, resource_subtype: undefined, recurrence: { type: null, data: null } });
            expect(client.tasks.create).to.have.been.calledWithExactly({ _sourceId: 101, workspace: orgId, name: "task2", html_notes: "<body>desc</body>", completed: true, start_on: "2023-11-15 00:00:00", due_on: "2023-11-30 00:00:00", force_public: false, hearted: false, resource_subtype: undefined, recurrence: { type: null, data: null } });
            // Milestone
        ...
        it("should create tasks with the correct 'force_public' fields (defaults to false)", function() {
            ...
            expect(exp.taskDataSource()(0,50).mapPerform("toJS")).to.deep.equal([
                { sourceId: 100, name: "task1", notes: "", creator: 1234, completed: false, startOn: null, dueOn: null, public: true, assigneeStatus: null, sourceAssigneeId: null, sourceItemIds: [], sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: null, customFieldValues: [] },
                { sourceId: 101, name: "task2", notes: "", creator: 1234, completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: null, sourceAssigneeId: null, sourceItemIds: [], sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: null, customFieldValues: [] },
                { sourceId: 102, name: "task3", notes: "", creator: 1234, completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: null, sourceAssigneeId: null, sourceItemIds: [], sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: null, customFieldValues: [] }
            ]);

            importer._importTasks();

            expect(client.tasks.create).to.have.callCount(3);
            expect(client.tasks.create).to.have.been.calledWithExactly({ _sourceId: 100, workspace: orgId, name: "task1", html_notes: "<body></body>", completed: false, start_on: null, due_on: null, hearted: false, force_public: true, resource_subtype: undefined, recurrence: { type: null, data: null } });
            expect(client.tasks.create).to.have.been.calledWithExactly({ _sourceId: 101, workspace: orgId, name: "task2", html_notes: "<body></body>", completed: false, start_on: null, due_on: null, hearted: false, force_public: false, resource_subtype: undefined, recurrence: { type: null, data: null } });
            expect(client.tasks.create).to.have.been.calledWithExactly({ _sourceId: 102, workspace: orgId, name: "task3", html_notes: "<body></body>", completed: false, start_on: null, due_on: null, hearted: false, force_public: false, resource_subtype: undefined, recurrence: { type: null, data: null } });
        });
        ...
        it("should create tasks with the correct recurrence fields", function() {
            ...
            expect(exp.taskDataSource()(0,50).mapPerform("toJS")).to.deep.equal([
                { sourceId: 100, name: "task1", creator: 1234, notes: "", completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: null, sourceAssigneeId: null, sourceItemIds: [], sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: "NEVER", customFieldValues: [] },
                { sourceId: 101, name: "task2", creator: 1234, notes: "", completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: null, sourceAssigneeId: null, sourceItemIds: [], sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: "{\"days_after_completion\":4,\"original_due_date\":1418342400000}", recurrenceType: "PERIODICALLY", customFieldValues: [] },
                { sourceId: 102, name: "task3", creator: 1234, notes: "", completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: null, sourceAssigneeId: null, sourceItemIds: [], sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: "{\"days_of_week\":[3,5],\"original_due_date\":1418342400000}", recurrenceType: "WEEKLY", customFieldValues: [] }
            ]);

            importer._importTasks();

            expect(client.tasks.create).to.have.callCount(3);
            expect(client.tasks.create).to.have.been.calledWithExactly({ _sourceId: 101, workspace: orgId, name: "task2", html_notes: "<body></body>", completed: false, start_on: null, due_on: null, hearted: false, force_public: false, resource_subtype: undefined, recurrence: { type: "PERIODICALLY", data: "{\"days_after_completion\":4,\"original_due_date\":1418342400000}" } });
            expect(client.tasks.create).to.have.been.calledWithExactly({ _sourceId: 102, workspace: orgId, name: "task3", html_notes: "<body></body>", completed: false, start_on: null, due_on: null, hearted: false, force_public: false, resource_subtype: undefined, recurrence: { type: "WEEKLY", data: "{\"days_of_week\":[3,5],\"original_due_date\":1418342400000}" } });
            expect(client.tasks.create).to.have.been.calledWithExactly({ _sourceId: 100, workspace: orgId, name: "task1", html_notes: "<body></body>", completed: false, start_on: null, due_on: null, hearted: false, force_public: false, resource_subtype: undefined, recurrence: { type: "NEVER", data: null } });
        });
    });
    ...
    describe("#_importStories", function() {
        it("should add stories to the correct task in the correct order, excluding AddAttachmentStory", function() {
            ...
            expect(exp.taskDataSource()(0,50).mapPerform("toJS")).to.deep.equal([
                {
                    sourceId: 300, name: "task1", notes: "", creator: 1234, completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: null, sourceAssigneeId: null, sourceItemIds: [], sourceFollowerIds: [], sourceBlockingTaskIds: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: null, customFieldValues: [],  stories: [
    ...
    describe("#_addSubtasksToTasks", function() {
        it("should add subtasks in the correct order", function() {
            ...
            expect(exp.taskDataSource()(0,50).mapPerform("toJS")).to.deep.equal([
                { sourceId: 100, name: "task1", creator: 1234,    notes: "", completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: null, sourceAssigneeId: null, sourceItemIds: [202, 201], sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: null, customFieldValues: []  },
                { sourceId: 201, name: "subtask2", creator: 1234, notes: "", completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: null, sourceAssigneeId: null, sourceItemIds: [],         sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: null, customFieldValues: []  },
                { sourceId: 202, name: "subtask3", creator: 1234, notes: "", completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: null, sourceAssigneeId: null, sourceItemIds: [],         sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: null, customFieldValues: []  }
            ]);
    ...
    describe("#_addDependenciesToTasks", function() {
        it("should add dependencies", function() {
            ...
            expect(exp.taskDataSource()(0,50).mapPerform("toJS")).to.deep.equal([
                { sourceId: 100, name: "precedent", creator: 1234, notes: "", completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: null, sourceAssigneeId: null, sourceItemIds: [], sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: null, customFieldValues: []  },
                { sourceId: 101, name: "dependent", creator: 1234, notes: "", completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: null, sourceAssigneeId: null, sourceItemIds: [], sourceFollowerIds: [], sourceBlockingTaskIds: [100], stories: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: null, customFieldValues: []  }
            ]);
    ...
    describe("#_addCustomFieldValuesToTasks", function() {
        it("should add custom field values to tasks", function() {
            ...
            expect(exp.taskDataSource()(0,50).mapPerform("toJS")).to.deep.equal([
                { sourceId: 300, name: "task1", creator: 1234, notes: "", completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: null, sourceAssigneeId: null, sourceItemIds: [], sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: null,
                    customFieldValues: [
                        {
                            protoSourceId: 100,
                            type: "text",
                ...
                { sourceId: 301, name: "task2", creator: 1234, notes: "", completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: null, sourceAssigneeId: null, sourceItemIds: [], sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: null,
                    customFieldValues: [
                        {
                            protoSourceId: 101,
                            type: "number",
    ...
    describe("#_addAssigneeStatusesToTasks", function() {
        it("should set the assignee status of tasks", function() {
            ...
            expect(exp.taskDataSource()(0,50).mapPerform("toJS")).to.deep.equal([
                { sourceId: 300, name: "task1", notes: "", creator: 1234, completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: "upcoming", sourceAssigneeId: null, sourceItemIds: [], sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: null, customFieldValues: [] },
                { sourceId: 301, name: "task2", notes: "", creator: 1234, completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: "upcoming", sourceAssigneeId: 100, sourceItemIds: [], sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: null, customFieldValues: [] },
                { sourceId: 302, name: "task3", notes: "", creator: 1234, completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: "later", sourceAssigneeId: 100, sourceItemIds: [], sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: null, customFieldValues: [] },
                { sourceId: 303, name: "task4", notes: "", creator: 1234, completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: "today", sourceAssigneeId: 100, sourceItemIds: [], sourceFollowerIds: [], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: null, customFieldValues: [] },
            ]);
    ...
    describe("#_addFollowersToTasks", function() {
        it("should add multiple followers to a task with a single request", function() {
            ...
            expect(exp.taskDataSource()(0,50).mapPerform("toJS")).to.deep.equal([
                { sourceId: 300, name: "task1", notes: "", creator: 1234, completed: false, startOn: null, dueOn: null, public: false, assigneeStatus: null, sourceAssigneeId: null, sourceItemIds: [], sourceFollowerIds: [100, 101], sourceBlockingTaskIds: [], stories: [], resourceSubtype: undefined, recurrenceData: null, recurrenceType: null, customFieldValues: []  }
            ]);
